...
//			This default code seems to be executed after hitting run, so it
//			set all weights and distances to -1. Thus, it should be commented out
//			for Dijkstra's and A* to work 
